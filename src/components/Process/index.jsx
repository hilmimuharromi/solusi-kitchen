        ...
        <div className=" row">
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                <h6 className="mb-10">Konsultasi Desain</h6>
                <p>Kami memiliki tim berpengalaman untuk mewujudkan desain idaman kalian</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="item">
              ...
              <div className="cont">
                <h6 className="mb-10">Pemilihan Material</h6>
                <p>pilih material sesuai kebutuhan dapur anda seperti ACP, Stainless Steel, Plywood/Blokboard, Duco dan HPL.</p>
              </div>
            </div>
          </div>
          <div
