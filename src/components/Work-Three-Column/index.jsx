        ...
        <div className="container">
          <div className="filtering text-center mb-30">
            <div className="filter">
              ...
              <span data-filter=".kitchen-set">kitchen Set</span>
              <span data-filter=".instalasi-gas">Instalasi Gas</span>
            </div>
          </div>
          <div className="row gallery">
            <div className="col-lg-4 col-md-6 items kitchen-set">
              <div className="item">
                <div className="img">
            ...
            <div className="col-lg-4 col-md-6 items residential kitchen-set">
              <div className="item">
                <div className="img">
            ...
            <div className="col-lg-4 col-md-6 items instalasi-gas">
              <div className="item">
                <div className="img">
            ...
            <div className="col-lg-4 col-md-6 items residential instalasi-gas">
              <div className="item">
                <div className="img">
